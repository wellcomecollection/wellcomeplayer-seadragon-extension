...
export class Provider extends coreProvider.Provider implements IWellcomeSeadragonProvider{
    ...
    getCrop(asset: any, viewer: any, download: boolean = false, relativeUri: boolean = false): string {
        ...
        var uri = String.prototype.format(this.config.options.cropImageUriTemplate, baseUri, this.pkg.identifier, this.assetSequenceIndex, asset.identifier, leftPx, topPx, widthPx, heightPx, cropWidth, cropHeight, asset.width, asset.height, rgn);
    ...
    getPDF(download: boolean = false): string {
        ...
        var uri = String.prototype.format(this.config.options.pdfUriTemplate, baseUri, this.pkg.identifier, this.assetSequenceIndex, this.pkg.identifier);
    ...
    getActualImageUri(asset: any): string {
        ...
        return String.prototype.format(this.config.options.actualImageUriTemplate, baseUri, this.pkg.identifier, this.assetSequenceIndex, asset.identifier);
    }
